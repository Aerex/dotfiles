...
if has('nvim-0.5')
  au VimEnter * luafile ~/.config/nvim/lua/init.lua
endif
...
if has("termguicolors")
  ...
  highlight! SignColum guibg=None
  highlight! Visual ctermfg=248
  highlight! Visual guibg=#CCD4DA guifg=#151515
  highlight! TelescopePromptPrefix ctermfg=110 guifg=#8fbfdc gui=bold
