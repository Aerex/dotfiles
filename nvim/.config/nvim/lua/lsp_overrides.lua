-- Taken from https://github.com/kristijanhusak/neovim-config/blob/ccb5eb7b02a227030b0c302981855226d531c1c9/nvim/lua/lsp_overrides.lua
local api = vim.api
local util = require'vim.lsp.util'
-- local outline = require'lua_extensions/vscode-languageserver.outline'
