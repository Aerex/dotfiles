...
c.aliases = {'run-cmd': 'spawn -u main.sh', 'json': 'spawn -u format_json', 'rst': 'restart', 'tg': 'tab-give'}
...
c.content.headers.user_agent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36'
...
## Type: List of Regex
# c.hints.next_regexes = ['\\bnext\\b', '\\bmore\\b', '\\bnewer\\b', '\\b[>→≫]\\b', '\\b(>>|»)\\b', '\\bcontinue\\b', '\\b[>]\\b' 'Next →' ]
c.hints.next_regexes = ['\\bnext\\b', '\\bmore\\b', '\\bnewer\\b', '\\b[>→≫]\\b', '\\bcontinue\\b', '\\b[>]\\b', '\\bOlder\\b']


## A comma-separated list of regexes to use for 'prev' links.
## Type: List of Regex
c.hints.prev_regexes = ['\\bprev(ious)?\\b', '\\bback\\b', '\\bolder\\b', '\\b[<←≪]\\b', '\\b(<<|«)\\b', '\\bNewer\\b']
...
'vw': 'http://vim.wikia.com/wiki/Special:Search?query={}',
'msdn': 'https://developer.mozilla.org/en-US/search?q={}',
'npm': 'https://www.npmjs.com/search?q={}',
'@types': 'https://github.com/types?q={}'
}
...
## Page to open if :ope -t/-b/-w is used withouth URL. use `about:blank` for a blank page
...
config.bind('`','set-cmd-text -s :run-cmd')
# config.bind('+', 'zoom-in')
...
#config.bind(';S', 'clear-keychain ;; search ;; fullscreen --leave')
config.bind('S', 'set-cmd-text -s :search')
config.bind('yp', ':spawn --userscript yank-url-path')
config.bind(';Y', 'hint links yank-primary')
config.bind('yu', ':spawn --userscript yankuuid')
...
config.bind(';kp', 'hint links spawn kodi -y "{hint-url}"')
config.bind(';kq', 'hint links spawn kodi -q "{hint-url}"')
config.bind(';krq', 'hint --rapid spawn kodi -q "{hint-url}"')
config.bind(';t', 'set-cmd-text -s :spawn --userscript taskadd')
...
# config.bind('H', 'back')
config.bind('<Space><Return>', 'set-cmd-text :')
...
config.bind('pul', ':spawn --userscript gotocrm')
config.bind('pua', ':spawn --userscript gotocrm Accounts')
#config.bind('<Space-b>', 'set-cmd-text -s :buffer')
...
config.bind('su', ':spawn --userscript showuuid')
...
#config.bind('<z><w>', 'spawn --userscript wallabag-add')
...
#config.bind('<Meta-W>', 'rl-kill-word', mode='command')
config.bind('<Meta-B>', 'rl-backward-word', mode='command')
config.bind('<Meta-G>', 'rl-forward-word', mode='command')
config.bind('<Ctrl-D>', 'rl-delete-char', mode='command')
config.bind('<Ctrl-F>', 'rl-forward-char', mode='command')
config.bind('<Ctrl-B>', 'rl-backward-char', mode='command')
config.bind('<Meta-B>', 'rl-backward-char', mode='command')
config.bind('<Ctrl-D>', 'completion-item-del', mode='command')
config.bind('<Ctrl-H>', 'rl-backward-delete-char', mode='command')
config.bind('<Ctrl-U>', 'rl-kill-line', mode='command')
config.bind('<Ctrl-J>', 'command-history-prev', mode='command')
config.bind('<Ctrl-K>', 'command-history-next', mode='command')
config.bind('<Ctrl-P>', 'command-history-prev', mode='command')
# config.bind('<Ctrl-Shift-Tab>', 'completion-item-focus prev-category', mode='command')
# config.bind('<Ctrl-Tab>', 'completion-item-focus next-category', mode='command')
config.bind('<Meta-L>', 'rl-unix-line-discard', mode='command')
# config.bind('<Ctrl-W>', 'rl-unix-word-rubout', mode='command')
#config.bind('y', 'rl-yank', mode='command')
